...
class FwcAlbumApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FlutterGetItApplicationBinding(
      //widget application bind para ficar sempre aberto esse bind
      bindingsBuilder: () => [
        Bind.lazySingleton<CustomDio>((i) =>
            CustomDio()), //precisa passar a interface, como não tem passa o customDio - instancia global disponivel em toda aplicação
        Bind.lazySingleton<AuthRepository>((i) => AuthRepositoryImpl(
            dio: i())), //Essa Bing de repositorio deve estar sempre disponivel
      ...
      child: MaterialApp(
        ...
        routes: {
          // '/':(_) =>  SplashPage(presenter: SplashPresenterImpl(),), //sem getit
          '/': (_) => const SplashRoute(),
